...
(1, 'Клининг', '4 этаж', '+78124493111', 1),
(1, 'Реклама', '4 этаж', '+78124493112', 1),
(1, 'Юрист', '4 этаж', '+78124493113', 1),
(1, 'Дирекция', '3 этаж', '+78124493114', 1),
(1, 'Бухгалтерия', 'цокольный', '+78124493115', 1);

INSERT INTO user (office_id, first_name, second_name, position, phone, doc_id, citizenship_code, version) VALUES
(1, 'Екатерина', 'Иванова', 'Менеджер', '+78125478530', 1, 1, 1),
(2, 'Сергей', 'Менников', 'директор', '+73141592654', 2, 2, 1),
(3, 'Михаил', 'Павликов', 'охранник', '+78156372569', 3, 3, 1);